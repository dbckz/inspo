...
class TestHexToRgba:
    ...
    def test_with_alpha(self):
        assert hex_to_rgba("#FF0000", alpha=0.5) == (1.0, 0.0, 0.0, 0.5)

    def test_without_hash(self):
        result = hex_to_rgba("FF6B6B")
        assert result[0] == 1.0
        assert 0.4 < result[1] < 0.5  # 6B/255 is approximately 0.42
...
class TestParseQuote:
    ...
    @pytest.fixture
    def app(self):
        """Create a mock InspirationAppMacOS instance for testing parse_quote."""
        return object.__new__(InspirationAppMacOS)

    def test_parse_quote_with_dash(self, app):
    ...
    def test_parse_quote_strips_quotes(self, app):
